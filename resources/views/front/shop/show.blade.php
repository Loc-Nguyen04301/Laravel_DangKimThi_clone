                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="product-details">
                                ...
                                <ul class="pd-tags">
                                    <li>
                                        <span>Categories</span>:{{$product->productCategory->name}}
                                    </li>
                    ...
                    <div class="product-tab">
                        <div class="tab-item">
                            <ul class="nav" role="tablist">
                                ...
                                <li>
                                    <a href="#tab-3" data-toggle="tab" role="tab">CUSTOMER REVIEWS (82)</a>
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <div class="product-content">
                                        <div class="row">
                                            <div class="col-7">
                                                <h5>Introduction</h5>
                                                <p>
                                                    Quiq makes it easy for customers to interact with a
                                                    company via Messaging. Customers can now engage
                                                    customer service via SMS/text messaging, Facebook
                                                    Messenger, Live Chat, and Kik for help with their
                                                    pre-sales questions and post-sales support.
                                                </p>
                                                <h5>Features</h5>
                                                <p>
                                                    Quiq makes it easy for customers to interact with a
