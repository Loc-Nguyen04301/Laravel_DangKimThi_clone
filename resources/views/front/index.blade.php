    ...
    <div class="deal-of-week set-bg spad" data-setbg="front/img/time-bg.jpg">
        <div class="container">
            <div class="col-6 text-center">
                ...
                <div class="countdown-timer" id="coutdown">
                    <div class="cd-item">
                        <span>56</span>
                        <p>Days</p>
                    </div>
                    ...
                    <div class="col-4">
                        <div class="single-latest-blog">
                            ...
                            <div class="latest-text">
                                <div class="tag-list">
                                    <div class="tag-item">
                                        <i class="fa fa-calendar-o">  {{date('M d,Y'),strtotime($blog->created_at) }} </i>
                                    </div>
                                    <div class="tag-item">
                                        <i class="fa fa-comment-o"> {{ count($blog->blogComments) }} </i>
                                    </div>
                                </div>
                                <a href="#">
                                    <h4>{{$blog->title}}</h4>
