        ...
        <div class="container">
            <div class="ht-left">
                <div class="mail-service">
                    <i class="fa fa-envelope"></i>nguyengialoc@gmail.com
                </div>
                <div class="phone-service">
                    <i class="fa fa-phone"></i>+8408082342
                </div>
            </div>
                                ...
                                <div class="cart-hover">
                                    <div class="select-items">
                                        <table>
                                            ...
                                            <tr>
                                                <td class="si-pic">
                                                    <img src="front/img/select-product-1.jpg"
                                                         alt=""/>
                                                </td>
                                                <td class="si-text">
            ...
            <div class="nav-depart">
                <div class="depart-btn">
                    ...
                    <ul class="depart-hover">
                        ...
                        <li><a href="#">Underweart</a></li>
                        <li><a href="#">Brand codelean </a></li>
        ...
        <div class="row">
            <div class="col-3">
                <div class="footer-left">
                    ...
                    <ul>
                        <li>Hoan Kiem</li>
                        <li>Phone: 63456346234</li>
                        <li>Email: nguyengialoc@gmail.com</li>
                    </ul>
            ...
            <div class="col-4">
                ...
                <p>Get Email about shop and special offers</p>
